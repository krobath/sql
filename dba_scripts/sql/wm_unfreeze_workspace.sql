...
-- |            workspace to unfreeze. The script then unfreezes the workspace. |
...
PROMPT 
PROMPT +------------------------------------------------------------------------+
PROMPT | Report   : Unfreeze Workspace                                          |
...
PROMPT 
ACCEPT wm_unfreeze_workspace_name CHAR PROMPT 'Enter name of workspace to unfreeze: '
PROMPT 
