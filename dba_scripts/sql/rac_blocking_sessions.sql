...
SELECT
  ...
  , s.serial#       serial_id
  , s.inst_id
  , s.final_blocking_session blocker
...
WHERE s.inst_id = p.inst_id 
	...
	AND (s.sid,s.inst_id) IN (SELECT s.final_blocking_session, s.final_blocking_instance FROM gv$session s where s.final_blocking_session IS NOT NULL)
