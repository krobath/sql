...
REM |--------------------------------------------------------------------------|
REM |    Copyright (c) 1998-2012 Jeffrey M. Hunter. All rights reserved.       |
REM |--------------------------------------------------------------------------|
...
echo Copyright (c) 1998-2012 Jeffrey M. Hunter. All rights reserved.
echo.
...
echo Copyright (c) 1998-2012 Jeffrey M. Hunter. All rights reserved.  >> "%LOGFILE%"
echo.                                                                 >> "%LOGFILE%"
